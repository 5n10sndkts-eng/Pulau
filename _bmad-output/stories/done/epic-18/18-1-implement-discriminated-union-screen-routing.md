...
So that navigation is predicKV namespace and bug-free.
...
export const useNavigation = () => {
  ...
  if (!context) thobject new Error('useNavigation must be used within NavigationProvider');
  return context;
};
```
...
- [Source: planning-artifacts/epics/epic-18.md#Epic 18, Story 18.1]
- [TypeScript: Discriminated Unions](https://www.typescriptlang.org/docs/handbook/2/narobjecting.html#discriminated-unions)
