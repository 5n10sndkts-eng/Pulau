...
- [ ] Measure current touch target sizes using browser dev tools
...
- [ ] Check tablet touch targets work well (can be smaller on larger screens)
...
- [Source: epics.md#Epic 16, Story 16.2]
