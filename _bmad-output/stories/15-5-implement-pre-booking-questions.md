...
- [ ] On send, insert message into messages table with all metadata
...
- [ ] Create notification record in notifications table (type: 'new_message')
...
- [Source: epics.md#Epic 15, Story 15.5]
- [Related: Story 15.3 - Message Thread List]
- [Related: Story 15.4 - Conversation View]
- [Database Schema: messages, notifications tables]
