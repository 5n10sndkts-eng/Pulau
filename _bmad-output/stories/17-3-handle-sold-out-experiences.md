...
- [ ] Create waitlist table schema (experience_id, user_id, email, created_at)
- [ ] Build "Join Waitlist" button component
- [ ] On click, insert record into waitlist table
- [ ] Send confirmation email to user
- [ ] Show success toast: "You'll be notified when spots open"

### Task 5: Vendor Notification System (AC: #3)
- [ ] Notify vendor when waitlist grows (e.g., >10 people)
...
```typescript
const getSimilarExperiences = async (experienceId: string, categoryId: string) => {
...
- [Source: epics.md#Epic 17, Story 17.3]
- [Database Schema: experience_availability, waitlist tables]
