...
6. ✅ Database schema: `user_profiles` table → TypeScript `UserProfile` interface
7. ✅ Navigation: `router.back()` → `navigate('/profile')` from React Router
8. ✅ Permissions: expo permissions API → Browser native file input (no permissions needed)
