...
3. **When** I use browser back button **Then** behavior matches in-app back button **And** no unexpected navigation loops
...
- [ ] Task 5: Integrate browser back button (AC: #3)
...
- [ ] Task 6: Test navigation flows (AC: #1, #2, #3)
  ...
  - [ ] Verify no memory leaks from unbounded history growth

## Dev Notes

- Use React state for navigation history (not browser history API exclusively)
- Sync React state with browser history for back/forward button support
