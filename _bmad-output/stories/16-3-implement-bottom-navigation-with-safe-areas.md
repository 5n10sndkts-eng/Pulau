...
- [ ] Explore tab: Compass icon, navigates to explore/browse
  ...
  return (
    <>
      ...
      ">
        ...
        <TabItem icon={Compass} label="Explore" active={currentScreen === 'explore'} />
        <TabItem
          icon={PlusCircle}
          label="Add"
          isCenter
        ...
        />
        <TabItem icon={Heart} label="Saved" active={currentScreen === 'saved'} />
        <TabItem icon={User} label="Profile" active={currentScreen === 'profile'} />
      </nav>
