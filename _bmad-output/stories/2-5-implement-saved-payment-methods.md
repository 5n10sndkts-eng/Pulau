...
2. Only last 4 digits and card brand (Visa/Mastercard) are stored in payment_methods table
3. payment_methods table includes: user_id, payment_token, last_four, card_brand, expiry_month, expiry_year, is_default
