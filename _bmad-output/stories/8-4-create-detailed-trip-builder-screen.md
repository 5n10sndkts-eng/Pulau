...
- [ ] Add header with back navigation, editable title, share button
...
### Task 2: Implement editable trip name in header (AC: #1)
- [ ] Create inline editable trip name component
...
- Inline edit: use contentEditable or controlled input with auto-focus
