...
- [ ] On Save, update experience_availability record via database mutation
...
- [ ] Before saving, query bookings table for existing bookings on selected date
...
- [Source: epics.md#Epic 15, Story 15.2]
- [Related: Story 15.1 - Display Availability Calendar]
- [Database Schema: experience_availability, bookings tables]
