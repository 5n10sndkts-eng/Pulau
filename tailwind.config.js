...
const defaultTheme = {
  ...
  extend: {
    ...
    colors: {
      // Bali-inspired design system colors
      primary: {
      ...
      success: {
        DEFAULT: "oklch(0.65 0.14 155)", // Soft Green #27AE60
        foreground: "oklch(1 0 0)", // White text
      },
      background: {
        DEFAULT: "oklch(0.98 0 0)", // Off-white
        card: "oklch(1 0 0)", // White
      },
      foreground: {
        DEFAULT: "oklch(0.25 0 0)", // Charcoal
        secondary: "oklch(0.45 0 0)", // Gray
      },
      // Radix UI neutral colors (preserved for UI components)
      neutral: {
    ...
    borderRadius: {
      // Bali-inspired border radius tokens
      card: "12px", // 12-16px for cards
      "card-lg": "16px",
      button: "8px", // 8px for buttons
      pill: "24px", // 24px for pills
      // Standard Radix UI radius (preserved)
      sm: "var(--radius-sm)",
      md: "var(--radius-md)",
      lg: "var(--radius-lg)",
      xl: "var(--radius-xl)",
    ...
    fontFamily: {
      display: ["Plus Jakarta Sans", "sans-serif"], // Headlines and navigation
      sans: ["Inter", "sans-serif"], // Body text
      accent: ["Caveat", "cursive"], // Special callouts (sparingly)
    },
  },
  spacing: {
    px: "var(--size-px)",
