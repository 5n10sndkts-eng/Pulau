...
export const experienceService = {
  ...
  getExperiencesByCategory: async (
    ...
    if (error) {
      console.error(
        '[experienceService] Error fetching experiences by category:',
        error,
      );
      throw error;
    }
  ...
  getExperiencesByDestination: async (
    ...
    if (error) {
      console.error(
        '[experienceService] Error fetching experiences by destination:',
        error,
      );
      throw error;
    }
  ...
  getExperiencesByIds: async (ids: string[]): Promise<Experience[]> => {
    ...
    if (error) {
      console.error(
        '[experienceService] Error fetching experiences by ids:',
        error,
      );
      throw error;
    }
