...
export function TravelerDetailsStep({
  ...
  const handleUpdateAdditionalTraveler = (
    ...
    updated[index] = { ...updated[index], [field]: value } as Omit<
      TravelerInfo,
      'email' | 'phone' | 'countryCode'
    >;
    ...
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            We'll need these details to confirm your bookings
          </p>
        </div>
      </div>
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          This person will receive all booking confirmations
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Select
                ...
                onValueChange={(value) =>
                  setLeadTraveler({ ...leadTraveler, countryCode: value })
                }
              >
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLeadTraveler({ ...leadTraveler, nationality: value })
              }
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleUpdateAdditionalTraveler(
                          index,
                          'firstName',
                          e.target.value,
                        )
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Let us know about any allergies, dietary restrictions, accessibility
          needs, or if you're celebrating something special
        </p>
