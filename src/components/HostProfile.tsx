...
export function HostProfile({ provider }: HostProfileProps) {
  return (
    <motion.div variants={fadeInUp} className="mt-12">
      <PremiumContainer
        variant="glass"
        className="p-6 border-primary/5 rounded-3xl"
      >
        <div className="flex gap-4 items-center mb-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge
                variant="secondary"
                className="text-[10px] rounded-full px-3 py-0.5 bg-primary/10 text-primary border-none"
              >
                {provider.rating} Rating
              </Badge>
              <Badge
                variant="secondary"
                className="text-[10px] rounded-full px-3 py-0.5 border-none"
              >
