    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                <Button variant="ghost" size="icon" onClick={onClose} aria-label="Close booking details">
            ...
            <Card className="p-4 bg-slate-50 border-slate-200">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Mail className={`w-5 h-5 ${isEmailSent ? 'text-green-600' : 'text-amber-500'}`} />
                        <div>
                    ...
                    >
                        {isResending ? <Loader2 className="w-3 h-3 mr-2 animate-spin" /> : <Send className="w-3 h-3 mr-2" />}
                                ...
                                <Card key={index} className="p-4 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2 text-sm">
                                            ...
                                            <a href="tel:+62361234567" className="text-primary hover:underline">
                                                +62 361 234 567
                                            </a>
                                        </div>
                                        <div className="flex items-center gap-2 text-sm">
                                            <Mail className="w-3 h-3 text-muted-foreground" />
                                            <a href={`mailto:support@pulau.app`} className="text-primary hover:underline">
                                                support@pulau.app
                                            </a>
                                        </div>
                                    </div>
            ...
            <div className="flex gap-2">
                ...
                <Button variant="outline" className="flex-1" onClick={() => toast.success('Details shared')}>
