    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <div className="px-6 py-8">
        ...
        <div className="space-y-4">
          <h2 className="font-display text-2xl font-bold">Explore Experiences</h2>
          <div className="grid grid-cols-2 gap-4">
            {categories.map((category, idx) => {
              ...
              return (
                ...
                >
                  <Card
                    className="relative overflow-hidden cursor-pointer group transition-all hover:shadow-xl hover:scale-[1.03] active:scale-[0.98]"
                  ...
                  >
                    ...
                    <div className="relative p-6 h-44 flex flex-col justify-end text-white">
                      <div className="bg-white/20 backdrop-blur-sm rounded-full w-12 h-12 flex items-center justify-center mb-3 group-hover:bg-white/30 transition-colors">
