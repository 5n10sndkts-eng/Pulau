...
export function EmailMetricsDashboard() {
  ...
  const deliveryRate = totals.sent
    ? ((totals.delivered / totals.sent) * 100).toFixed(1)
    : '0.0';
  const bounceRate = totals.sent
    ? ((totals.bounced / totals.sent) * 100).toFixed(1)
    : '0.0';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Real-time tracking of transactional emails
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Failed or bounced emails requiring attention
            </CardDescription>
          </CardHeader>
          <CardContent>
