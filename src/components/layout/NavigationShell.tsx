...
import { Home, Compass, PlusCircle, Heart, UserCircle, Map } from "lucide-react"
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Icon className={cn("w-6 h-6 transition-transform group-hover:scale-110", isActive && "fill-current")} />
