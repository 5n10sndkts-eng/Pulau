...
export function TicketPageRoute() {
    ...
    if (!booking) {
        return <TicketPage ticketData={undefined} onBack={() => navigate('/trips')} />
    }
    ...
    const experience = firstItem ? getExperienceById(firstItem.experienceId) : null
    ...
    const ticketData = {
        ...
        dateTime: firstItem?.date && firstItem?.time ? `${firstItem.date}T${firstItem.time}` : booking.bookedAt,
