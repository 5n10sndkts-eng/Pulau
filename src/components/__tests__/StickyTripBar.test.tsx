...
function AddItemsButton() {
  ...
  return (
    <button onClick={() => addToTrip('exp_new', 2, 50)}>
      Add Item
    </button>
  )
}
...
describe('StickyTripBar', () => {
  ...
  describe('AC #5: Interaction & Expansion', () => {
    it('should open Drawer when bar is clicked', async () => {
      ...
      const tripBar = await screen.findByRole('button', { name: /view trip summary/i })
    ...
    it('should have proper accessibility attributes', async () => {
      ...
      const tripBar = await screen.findByRole('button', { name: /view trip summary: 1 items for \$220\.00/i })
