...
import { ArrowLeft, Upload, X, Image as ImageIcon, Check, Loader2, GripVertical, Trash2 } from 'lucide-react'
...
export function ExperienceImageUploadScreen({ onBack, onComplete }: ExperienceImageUploadScreenProps) {
    ...
    const processFiles = async (files: File[]) => {
        ...
        const newRecords: ExperienceImageRecord[] = validFiles.map((file, index) => ({
    ...
    return (
        <div className="min-h-screen bg-background pb-20">
                ...
                <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Add at least 3 photos</p>
                        </div>
                    </div>
                    <Button
                        onClick={onComplete}
            ...
            <div className="max-w-4xl mx-auto p-6 space-y-8">
                ...
                {/* Upload Zone */}
                <div
                    className={`border-2 border-dashed rounded-xl p-12 text-center transition-colors ${uploading ? 'border-primary/50 bg-primary/5' : 'border-muted-foreground/25 hover:border-primary hover:bg-muted/50'
                        }`}
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold">Drag & drop your photos here</h3>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        {images.length > 0 && <p className="text-sm text-muted-foreground">Drag items to reorder</p>}
                    </div>
