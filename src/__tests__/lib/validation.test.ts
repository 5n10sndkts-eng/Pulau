...
import { validatePassword, validateEmail, sanitizeInput, PASSWORD_MIN_LENGTH, PASSWORD_MAX_LENGTH } from '@/lib/validation'
...
describe('Password Validation', () => {
  describe('Length Requirements', () => {
    ...
    it('should reject very long password (> 128 chars)', () => {
      ...
      expect(result.valid).toBe(false)
      expect(result.errors).toContain(`Password cannot exceed ${PASSWORD_MAX_LENGTH} characters`)
    })
